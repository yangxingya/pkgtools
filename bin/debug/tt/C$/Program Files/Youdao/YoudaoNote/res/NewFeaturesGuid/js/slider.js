$(function() {
    ...
    $lightbox.mouseenter(function(){ $closeBtn.html('<img src="images/close2.png">'); });
    $lightbox.mouseleave(function(){ $closeBtn.html('<img src="images/close1.png">'); });
    //设定intervalTime自动翻页
    nIntervid = window.setInterval(autonext, intervalTime);
    ...
    $closeBtn.click(function () {
        if (window.YNote.CloseNewFeatureGuidForm) {
