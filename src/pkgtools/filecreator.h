//!
/// filecreator.h define file creator
///

#if !defined(pkgtools_file_creator_h_)
#define pkgtools_file_creator_h_
...
struct FileCreator
{
    FileCreator(std::string const& file, std::string const& mode)
...
#endif // pkgtools_file_creator_h_