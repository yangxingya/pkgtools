...
struct PkgMaker
{
    PkgMaker(argv::AutoArgvList const& arglist, std::string const& to = kdefaultoutput)
...
private:
    ...
    void extractArgv()
    {
        ...
        entry::ArgvTransfer argvtransfer(pkg_argvs_);
    ...
    entry_t extract(argv::AutoArgv const& argv)
    {
        entry_t entry;
    ...
    entry_t transfer(argv::FileArgv *fargv)
    {
        entry_t entry;
    ...
    entry_t transfer(argv::DirArgv *dargv)
    {
        entry_t entry;
    ...
    entry_t transfer(argv::ExecArgv *eargv)
    {
        entry_t entry;
